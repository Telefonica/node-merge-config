...
var lodashMerge = require('lodash/merge'),
    lodashProperty = require('lodash/property'),
...
function Configuration() {
  ...
  function get(composedKey) {
    ...
    return lodashProperty(adaptedKey)(config);
  }
  ...
  function set(composedKey, value) {
    var adaptedKey = _fixComposedKey(composedKey);
    lodashSet(config, adaptedKey, value);
  }
